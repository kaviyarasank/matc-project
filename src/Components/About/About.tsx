...
function About(){
    ...
    return(
     <div className="aboutMain">
         ...
         <p  className="aboutcontent">Rolex watches are designed and built to last thanks to the dedicated watchmakers, 
         designers and engineers whose skills and knowledge are transferred into each and every Rolex timepiece.
          Rolex is proud to present the work of these outstanding specialists.</p>
          <p className="aboutcontent">Rolex has registered over 500 patents in the course of its history. 
              Few companies have been so consistently identified with the pursuit of excellence, 
              the quest for the absolute, the discovery of original approaches and innovative solutions.</p>
              <p className="aboutcontent">We call this perpetual spirit. It is based on a fundamental belief in unlimited human potential, 
                  in continuous improvement and lasting excellence, 
                  in always pushing the boundaries and taking the long-term view. 
                  Our watches are built to last. So is our contribution to future generations. 
                  Discover more about our corporate commitments on Rolex.org</p>

<div className="sidelineabout mt-5">Our Vision</div>
         <p className="mt-3 aboutcontent">Clearly identify the corporate culture, values, strategy and view of the future by interviewing employees, suppliers and customers
...
Develop buy-in and support throughout the organization<br/>Guide management’s thinking on strategic issues, especially during times of significant change
